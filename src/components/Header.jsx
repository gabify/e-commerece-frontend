        ...
        <>
            <header className="shadow-lg shadow-gray-500/5 font-Quicksand">
                <section className="grid grid-cols-12 items-center-safe pb-2 px-2">
                    <h1 className="col-span-5 md:col-span-2 lg:order-2 md:place-self-center-safe text-2xl font-bold font-bebas tracking-wide cursor-pointer max-lg:pt-2">Block Market</h1>
                    ...
                    <nav className={`max-md:col-span-12 ${isShown ? 'block' : 'hidden'} md:flex gap-0 col-start-8 lg:col-span-5 lg:order-1`}>
